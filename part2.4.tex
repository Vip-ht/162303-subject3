...
\paragraph{}
Tính năng hot reload là một trong những điểm mạnh chính mà Flutter mang lại cho các nhà phát triển của họ, vì nó cho phép họ nhìn thấy các thay đổi ngay lập tức, giúp việc phát triển trở nên nhanh chóng. Hơn nữa, Flutter cung cấp đồ họa hiệu năng cao và animation mượt mà nhờ vào công cụ render Skia. 
\paragraph{}
...
\paragraph{}
Cho đến nay, hoặc cho đến thời điểm tài liệu này được viết, trên mạng không có nhiều thông tin về Flutter và Dart. 
\paragraph{}
...
\paragraph{}
Flutter có những ưu điểm như hot reload, phát triển nhanh hơn, dễ sử dụng, v.v., như được minh họa trong Hình~\ref{fig:loi_ich_flutter}, do đó làm cho Flutter trở thành một lựa chọn tốt cho thiết kế giao diện người dùng đa nền tảng. [21]  
\paragraph{}
Flutter cung cấp một bộ widget tốt có thể trừu tượng hóa cho đa nền tảng và với bố cục thích ứng, không phụ thuộc vào widget nền tảng. Điều này khiến nó rất phù hợp để tạo ra các thiết kế bố cục chính xác cho cả Android, iOS, cũng như các thiết bị khác. Nhờ Google img2img, Flutter và Dart đang được sử dụng ngày càng nhiều cho phát triển đa nền tảng với quá trình phát triển rất mượt mà và hiệu năng gần giống như native.
...
Hình~\ref{fig:kien_truc_flutter} này cho thấy Kiến trúc Dựa trên Widget của Flutter bao gồm ba lớp: Lớp Ứng dụng (logic đối tượng/nghiệp vụ với Blocs), Lớp Miền (kho dữ liệu) chịu trách nhiệm về luồng dữ liệu, Lớp Dữ liệu (API bên ngoài, Firebase(trong trường hợp này) và Hive). 
\paragraph{}
\textbf{Hiển thị Pixel-Chính xác:} Skia - engine render của Flutter - tạo ra giao diện người dùng trực quan và chất lượng cao trên các thiết bị và nền tảng [24]. Các nhà thiết kế và lập trình viên có thể tạo ra trải nghiệm họ muốn mà không bị ràng buộc bởi một bộ widget GUI cụ thể.
...
\paragraph{}
\textbf{Tính nhất quán đa nền tảng:} Flutter mang đến hẹn sự thống nhất trên các nền tảng khác nhau như Android và iOS cho một giao diện người dùng tương tự và cơ hội để tránh việc tốn nhiều thời gian đảm bảo chúng luôn nhất quán [25].
...
\end{figure}
Như được thấy trong hình~\ref{fig:flutter_da_nen_tang}, Flutter cung cấp nhiều lợi thế cho phát triển đa nền tảng: cơ sở mã nhanh, nhẹ, nhất quán, hỗ trợ hot reload cùng với nhiều tùy chọn tùy chỉnh nhanh và phong phú. 
\paragraph{}
\textbf{Animation tùy chỉnh:} Flutter có một lớp animation giúp người dùng tạo ra nhiều animation và transition khác nhau cho ứng dụng của họ, do đó, luồng trong ứng dụng được quản lý tốt. 
\paragraph{}
\textbf{Thiết kế đáp ứng:} Hệ thống bố cục linh hoạt của Flutter cho phép mở rộng khả năng phát triển giao diện người dùng mẫu, có thể đáp ứng linh hoạt với nhiều kích thước và mật độ màn hình khác nhau. Những tính năng này khiến Flutter trở thành nền tảng được ưa chuộng cho các nhà phát triển muốn mang đến những ứng dụng chất lượng cao, giàu giá trị thẩm mỹ, được ra mắt trong thời gian ngắn nhất có thể.
...
\paragraph{}
\textbf{Cộng đồng nhà phát triển năng động}: Flutter cũng có một trong những hệ sinh thái nhà phát triển lớn nhất đối với bất kỳ framework đa nền tảng nào trên thị trường. Các cộng đồng này cung cấp thư viện plugin và tài nguyên từ những người đóng góp để hỗ trợ và làm phong phú việc phát triển [14]. Có hàng ngàn chủ đề và câu trả lời trên GitHub và Stack Overflow liên quan đến các vấn đề và giải pháp về Flutter.
...
\paragraph{}
\textbf{Sự chấp nhận bởi các ngành công nghiệp:} Các doanh nghiệp và nhà phát triển đã công nhận Flutter, ví dụ: Alibaba, eBay và BMW. Điều này chứng minh rằng nó có khả năng xử lý các ứng dụng quy mô lớn, đạt cấp độ sản phẩm. 
