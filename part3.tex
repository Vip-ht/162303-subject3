...
khả năng tương tác với Native API, hiệu năng và sự hỗ trợ của cộng đồng
...
\paragraph{}
Trong nghiên cứu này, mục tiêu chính là đưa ra một phân tích toàn diện về hiệu năng,
năng suất của nhà phát triển và tương tác với Native API, cũng  như  sự  hỗ  trợ  của  cộng  đồng  đối  với  React  Native,
...
\paragraph{}
 ...
 được  đánh  giá  về  mặt  hiệu  năng.  Các  ứng  dụng  được  đánh  giá  dựa  trên  thời  gian  khởi  động,  mức  sử  dụng  bộ  nhớ,
 Tiêu  thụ  CPU  và  khả  năng  phản  hồi  của  giao  diện  người  dùng.  Trong  các  ứng  dụng  này,  chúng  ta  có  thể  kiểm  soát
 môi  trường  để  đo  lường  và  so  sánh  các  số  liệu  cốt  lõi  về  hiệu  năng  cho  từng framework.  Ngoài  ra,
...
Nghiên  cứu  này  nhằm  mục  đích  đưa  ra  đánh  giá  toàn  diện  và  cân  bằng  về  React  Native,
 ...
 yêu  cầu,  không  chỉ  xem  xét  hiệu  năng  kỹ  thuật  mà  còn  cả  sự  hài  lòng  của  nhà  phát  triển  và sự
...
\paragraph{}
 ...
 \begin{itemize}[label=\scalebox{1.5}{$\bullet$}]
    ...
    \item Khả năng tương tác với Native API
    \item Hiệu năng
...
Đánh  giá  trong  nghiên  cứu  này  phụ  thuộc  cơ  bản  vào  các  framework đã chọn:  React Native
 ...
 cả  tính  hợp  lệ  và  tính  thực  tiễn  của nghiên  cứu đối  với phát  triển ứng  dụng  di  động  hiện  đại
...
\paragraph{}
 ...
 và  trong  một  số  trường  hợp,  điều  này  có  thể  gây  ra  tình  trạng  nghẽn cổ chai  hiệu  năng.
\begin{figure}[h!]
    \centering
...
súc  tích  và  an  toàn  về  kiểu  chữ của Kotlin trên  cả  hai  nền  tảng.  Bằng  cách  đó,  một  mã nguồn 
 ...
 các  nhà  phát  triển  và  UI  được  duy  trì  với  các  thành  phần  native  cho  từng  nền  tảng.  Tính  năng  tốt  nhất
 của  việc  sử  dụng  Kotlin  Đa  nền  tảng  so  với  các framework  khác là trừu  tượng  hóa  cả  UI  và  logic  thành  một
mã cơ  sở  duy nhất,  ở  đây  là  cách  tiếp  cận  này  cung  cấp  sự  cân  bằng  tuyệt  vời  giữa  hiệu  năng  native  và
 tái  sử  dụng  mã.
\paragraph{}
 Đặc  biệt,  các  nhóm  có  kinh  nghiệm  phát  triển  ứng  dụng  di  động bằng ngôn ngữ native (Java, Swift, v.v.)  được  thu  hút  
...
\begin{itemize}[label=$\circ$]
 ...
 Android).
\end{itemize}
\subsection{Dễ  dàng  tương  tác  với Native API:}
\begin{itemize}[label=$\circ$]
    \item \textbf{Truy  cập  vào  các  tính  năng  native:}   Dễ  dàng  truy  cập  và  tương  tác  với  các Native  API  
 như  máy  ảnh,  GPS  và  cảm  biến  thiết  bị.
    \item \textbf{Khả năng  tương  thích  đa  nền  tảng:} Mức  độ  trừu  tượng  hóa  các Native API đặc biệt 
  trong  khi  vẫn  duy  trì  hiệu  năng  native.
\end{itemize}
\subsection{Hiệu  năngt:}
\begin{itemize}[label=$\circ$]
    \item \textbf{Thời  gian  khởi  động:}   Thời  gian  cần  thiết  để  ứng  dụng  sẵn  sàng  cho  người  dùng
 sự  tương  tác.
    \item \textbf{Hiệu  năng  thời  gian  chạy:}   Độ  mượt  của  kết  xuất  UI,  bộ  nhớ  và  mức  sử  dụng  CPU
...
\paragraph{}
 Dữ  liệu  thu  thập  được  thông  qua  các đo đạc  hiệu  năng,  khảo  sát  nhà  phát  triển  và đánh giá từ cộng  đồng
  có  thể  được  phân  tích  bằng  cả  thống  kê  mô  tả  và  phân  tích  chuyên  đề.
\begin{itemize}
  \item So  sánh  được  thực  hiện  bằng  cách  sử  dụng  số  liệu  hiệu  năng,  thời  gian  xây  dựng  và  độ  phức  tạp  của  mã nguồn.
...
\paragraph{}
 ...
 phân  tích,  dữ  liệu  thu  thập  được  của  các  giai  đoạn  trước  của  nghiên  cứu,  các  bài đo hiệu  năng  và
...
\paragraph{}
 ...
 CPU  tiêu  thụ,  khả  năng  phản  hồi  của  UI) ...  để  so  sánh  điểm  chuẩn  hiệu  năng  với  số  liệu  thực  tế
 từ  các  điểm  chuẩn  hiệu  năng.  Tóm  tắt  hiệu  năng  của  các  ứng  dụng  được  phát  triển  bằng  cách  sử  dụng  từng
framework sử  dụng  các  phương  pháp  thống  kê  như  trung  bình,  độ  lệch  chuẩn  và  phương  sai.  Phương pháp cặp
 ...
 phát hiện  ra  khi  nào  có  sự  khác  biệt  về  hiệu  năng  hoặc  khi  nào  chúng  chỉ  là  do  lỗi  ngẫu  nhiên.
...
\paragraph{}
 ...
 hiểu  biết  sâu  sắc  của  cộng  đồng  và  cùng  nhau  hình  thành  nên  cái  nhìn  toàn  diện  về  hiệu  năng  của  các số  liệu của framework.
Trong  trường  hợp  như  vậy,  chúng  ta  có  thể  nhận  thấy  sự  khác  biệt  giữa  hiệu  năng  được  quan  sát  thấy  trong
 các  bài  kiểm  tra  chuẩn  mực  và  khó  khăn  được  báo  cáo  do  tích  hợp Native API  gây  ra.  Việc  sử  dụng
...
\begin{itemize}
 ...
 phiên  bản  phần  cứng  hoặc  hệ  điều  hành  cụ  thể  được  sử  dụng  trong  các  bài  kiểm  tra  hiệu  năng.
