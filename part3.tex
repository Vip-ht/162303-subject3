...
khả năng tương tác với Native API, hiệu suất và sự hỗ trợ của cộng đồng
...
\begin{itemize}[label=$\circ$]
    \item \textbf{Truy  cập  vào  các  tính  năng  gốc:}   Dễ  dàng  truy  cập  và  tương  tác  với  các Native  API  
