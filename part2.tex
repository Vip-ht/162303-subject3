...
\paragraph{}
Chương này dường như  tạo tiền đề cho phần phân tích so sánh ở các mục sau bằng cách thiết lập nền tảng hiểu biết vững chắc về những công nghệ này. Những hiểu biết đó giúp các nhà phát triển, quản lý dự án và tổ chức cân nhắc framework nào phù hợp cho việc phát triển ứng dụng di động.
\input{part2.1.tex}
\input{part2.2.tex}
\input{part2.3.tex}
\input{part2.4.tex}
