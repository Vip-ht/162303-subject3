...
với các ứng dụng yêu cầu hiệu năng tính toán tối ưu hoặc tích hợp chi tiết với các chức năng native của nền tảng.
...
logic nghiệp vụ giống hệt nhau trên cả hai hệ điều hành nhưng vẫn đảm bảo giao diện người dùng nhất quán.
Do đó, giải pháp này rất hiệu quả đối với các tổ chức ưu tiên hiệu năng native và khả năng áp dụng vào các nền tảng cụ thể.
...
Để được tích hợp vào quy trình phát triển, cùng với các ứng dụng khác, một ứng dụng tài chính có thể cần có hiệu năng cao, 
...
Đối với lĩnh vực này, KMM phù hợp với hiệu năng ở cấp độ nền tảng và khả năng sử dụng trực tiếp Native API.
...
\paragraph{}
Điểm hiệu quả của KMM là khi cần hiệu năng và giao diện giống như native, nhưng lại không hiệu quả trong các ứng dụng có giao diện người dùng rất nặng, 
...
Để minh họa điều này, chúng ta có ví dụ thực tế về việc Alibaba đã tận dụng thành công Flutter để xây dựng ứng dụng hoạt động trên nhiều nền tảng với hiệu năng tuyệt vời.
...
trang web để chạy trên mọi nền tảng mà vẫn mang lại hiệu năng ấn tượng và tuân thủ
...
trong khi KMM sẽ hiệu quả hơn nếu cần tích hợp sâu với các tính năng dành riêng cho nền tảng và tối ưu hóa hiệu năng dành riêng cho nền tảng.